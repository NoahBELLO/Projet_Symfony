 ...
 */
final class Version20250605121725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE job_categorie (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE job_categorie_job (job_categorie_id INT NOT NULL, job_id INT NOT NULL, INDEX IDX_7EB17F35B3967202 (job_categorie_id), INDEX IDX_7EB17F35BE04EA9 (job_id), PRIMARY KEY(job_categorie_id, job_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE job ADD CONSTRAINT FK_FBD8E0F81224ABE0 FOREIGN KEY (compagny_id) REFERENCES compagny (id)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE job_categorie_job ADD CONSTRAINT FK_7EB17F35B3967202 FOREIGN KEY (job_categorie_id) REFERENCES job_categorie (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE job_categorie_job ADD CONSTRAINT FK_7EB17F35BE04EA9 FOREIGN KEY (job_id) REFERENCES job (id) ON DELETE CASCADE
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE job DROP FOREIGN KEY FK_FBD8E0F81224ABE0
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE job_categorie_job DROP FOREIGN KEY FK_7EB17F35B3967202
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE job_categorie_job DROP FOREIGN KEY FK_7EB17F35BE04EA9
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE compagny
        SQL);
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE job_categorie
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE job_categorie_job
        SQL);
        $this->addSql(<<<'SQL'
            DROP TABLE job_type
        SQL);
